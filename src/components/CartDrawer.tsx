            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 border border-border rounded">
                      <div className="w-16 h-16 bg-card rounded overflow-hidden flex-shrink-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-medium text-foreground mt-1">{item.price.currencyCode} {parseFloat(item.price.amount).toFixed(2)}</p>
                      </div>
